        ...
        <div class="panel panel-body">
			...
			onsubmit="return confirm('Are you sure you want to add a new medicine class?')">
				...
				<form:input type="text" class="form-control input-sm" id="inputName" 
    							placeholder="Enter Medicine Class Name" path="uid"></form:input>
		 		</div>
		 		</div>
				
				
		<div class="row form container row-padding">	
		<button class="btn btn-success btn-lg text-center" type="submit" value="Save">Add Medicine Class<span class="glyphicon glyphicon-saved"></span></button>
		</div>
	</form:form>
