...
<body>
	...
	<div class="panel panel-default">
    	<div class="panel panel-heading"><h3>Administrator Edit Facilities View</h3></div>
	...
	<div class="panel panel-default">
        ...
        <div class="panel panel-body">
			...
			onsubmit="return confirm('Are you sure you want to Save Changes?')">
				...
				<div class=col-lg-6>
				<form:input type="text" class="form-control input-sm" id="inputName" 
    							placeholder="Enter Facility Name" path="officialName"></form:input>
		...
		<button class="btn btn-success btn-lg text-center" type="submit" value="Save">Edit Facility<span class="glyphicon glyphicon-saved"></span></button>
		</div>
	</form:form>
