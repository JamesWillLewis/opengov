...
<body>
	...
	<c:if test="${currentPage != 1}">
		<li><a
			href="<c:url value="/sows/admin/medicines?page=${currentPage - 1}"/>">&laquo;</a></li>
	</c:if>
			...
			<c:forEach begin="1" end="${noOfPages}" var="i">
				<c:choose>
					...
					<c:otherwise>
						<li><a
							href="<c:url value="/sows/admin/medicines?page=${i}"/>">${i}</a></li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
		...
		<li><a
			href="<c:url value="/sows/admin/medicines?page=${currentPage + 1}"/>">&raquo;</a></li>
		</c:if>
	</ul>
	</div>
	</div>
