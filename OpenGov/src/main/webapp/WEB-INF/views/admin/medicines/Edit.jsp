...
<body>
	...
	<div class="panel panel-default">
    	<div class="panel panel-heading"><h3>Administrator Medicines Edit View</h3></div>
	...
	<div class="col-lg-8">
	<div class="panel panel-default">
    	<div class="panel panel-heading"><h3>Edit Medicine</h3></div>
        <div class="panel panel-body">
	
			<form:form action="${uid}/update" method="POST" modelAttribute="medicinewrapper">
		...
		<button class="btn btn-success btn-lg text-center" type="submit" value="Save">Save Changes<span class="glyphicon glyphicon-saved"></span></button>
		</div>
	</form:form>
